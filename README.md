...
A custom, bare-metal Real-Time Operating System (RTOS) built from scratch for the ARM Cortex-M4 architecture (TM4C1294NCPDT / MSP432E401Y Launchpad). No HAL. No vendor RTOS libraries. Every line is direct register access.
...
- OS_Sleep for tick-based task blocking — zero busy-wait cycles
...
bsp/
  ...
  gpio.c / gpio.h           — LED pin configuration
