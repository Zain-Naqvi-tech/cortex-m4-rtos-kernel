...
A bare-metal RTOS built from scratch on the ARM Cortex-M4 (TM4C1294NCPDT Launchpad). No HAL. No vendor RTOS libraries. Every line of kernel code — the context switch, the scheduler, the allocator — was written and debugged by hand against the ARM architecture technical reference manual and the chip datasheet.
...
Target: TM4C1294NCPDT (Connected Launchpad)  
